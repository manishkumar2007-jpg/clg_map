    ...
    const locations = [
      ...
      },
      {
        ...
        lng: 79.015154,
        tags: ["hostel"],
        path_main:"take right firs.t then take left. and go straight.  after the passing arundathi S N old can be reached. ",
      },
      {
        name: "SN New hostel",
        type: "Hostel",
      ...
      },
      {
        ...
        lng: 79.01602,
        tags: ["School"],
        path_main:"just take right. and the first block is sath vihar",
      },
      {
        ...
        path_main:"go straight. on right side the temple will be there",
      },
      {
      ...
      },
      {
        ...
        lng: 79.017024,
        tags: ["School", "Civil"],
        path_boys:"from hostel entrance take right. and go ahead. again take right and go straight. take left. the block was on the right side opposite to the play groung.",
      ...
      },
      {
        ...
        path_boys:"from hostel entrance. take right. and go ahead. again take right. and go straight. take left. and go straight. then take left you will be reached.",
        path_girls:"go straight. and follow the road. the block was exact opposite to the turn.",
        path_main:"go straight. and follow straight path. take left.and go straight. again take left you will be reached.",
      },
      {
        name: "Vidyut Vihar",
        type: "Academic",
        ...
        lng: 79.019446,
        tags: ["School", "EEE"],
        path_boys:"from hostel entrance. take right. and go ahead. again take right. and go straight. take left. again go straight. then take left. next take right. and go ahead the block was on left side.",
        path_girls:"go straight and follow the path. after passing the KC canteen. the block was on right side.",
        path_main:"go straight. and follow straight path. take left go straight. then take left. next take right and go ahead the block was on left side.",
      },
      {
        ...
        path_boys:"from hostel entrance. take right. and go ahead. and take right. go straight and take left. again go straight. then take left. next take right and go straight. after passing KC. the block was on left side",
        path_girls:"go straight fron hostel gate. and on right side. the block is there.",
        path_main:"go straight. and follow straight path. take left go straight. then take left. next take right and go straight. after passing th KC. the block was on left side.",
      },
      {
        ...
        lng: 79.018298,
        tags: ["Center", "Gym"],
        path_boys:"from hostel entrance. take right. go ahead. again take right and go straight. take left and go straight. then take right. opposite side of J V C path you will be reached.",
      ...
      },
      {
        ...
        lng: 79.019006,
        tags: ["Hospital", "Shop"],
        path_boys:"from hostel gate. go straight. and take right. again go straight without taking any further turn. after crossing 2 road turns. the block was on right side. the shops are on first floor. and the hospital was on ground floor.",
        path_girls:"from road side hostel gate. go straight. and on right side the block is there.",
        path_main:" take right.and go straight without taking any further turn. after crossing 2 road turns. the block was on right side.",
      },
      {
        name: "Cith Vihar",
        type: "Academic",
      ...
      },
      {
        ...
        path_main:"take right.and go straight without taking any further turn. the last block. on right side was TIFAC core.",
      },
      {
        ...
        lng: 79.020092,
        tags: ["Center", "Library"],
        path_boys:"from hostel gate. take right. and go straight without any turn. you can see foot path along the way. go straight. finally take right turn. the library was just opposite to football ground.",
        path_girls:"from the hostel gate. go straight. and turn right from KC and go straight. library was on right side.",
      ...
      },
      {
        ...
        path_boys:"from hostel gate take right. go straight without any turn. you can see foot path along the way. go straight. finally take left turn. and one right turn. then go straight the block entrence was on right side.",
        path_girls:"from hostel gate go straight. and take right turn opposite to VKJ. again go straight. the block on left side was S O C.",
        path_main:"take right from the main entrance. and then turn right on the first road. go straight and turn left. again go straight along the foot path without any further turn. then take left turn and one right turn. go straight the block entrence was on right side.",
      },
      {
        name: "SHASHE",
        type: "Academic",
      ...
      },
      {
        ...
        lng: 79.020046,
        tags: ["Canteen", "Food"],
        path_boys:"from hostel entrance take right. and go ahead. again take right and go straight. take left and go straight. then take left. next take right and go straight. after passing V V the canteen was on left side.",
        path_girls:"from hostel gate. go straight without any turn. the K C was on left side.",
        path_main:"go straight. and follow straight path. take left and go straight. then take left. next take right and go straight. after passing V V. the canteen was on left side.",
      },
      {
        ...
        lng: 79.020751,
        tags: ["Center"],
        path_boys:"from hostel gate. take right. and go straight without any turn. you can see foot path along the way. go straight. finally take left turn and one right turn. then go straight. you can see T D C on right side.",
        path_girls:"from hostel gate go straight. and take right turn opposite to VKJ. go straight. the block on right side was T D C.",
        path_main:"take right from the main entrance. and then turn right on the first road. go straight and turn left. again go straight along the foot path without any further turn. then take left turn. and one right turn. then go straight. you can see T D C on right side.",
      },
      {
      ...
      },
      {
        ...
        lng: 79.021821,
        tags: ["Research block"],
        path_boys:"follow the path upto VKJ from hostel. and go straight. turn left. the blue colour block on left side was A S K 1",
        ...
        path_main:"follow the path upto VKJ from main gate. and go straight. turn left. the blue colour block on left side was A S K 1.",
      },
      {
        name: "A S K 2",
        type: "Research block",
        ...
        lng: 79.021839,
        tags: ["Research block"],
       path_boys:"follow the path upto VKJ from hostel. and go straight. turn left. the blue colour block on right side was A S K 2",
        ...
        path_main:"follow the path upto VKJ from main gate. and go straight. turn left. the blue colour block on right side was A S K 2.",
      },
      {
        name: "A S K 3",
        type: "Research block",
        ...
        lng: 79.022354,
        tags: ["Research block"],
        path_boys:"follow the path upto VKJ from hostel. and go straight. turn left. the orange colour block on left side was A S K 3.",
        path_girls:"from hostel gate take left turn. and go straight. and again turn left. the orange colour block on left side was A S K 3.",
        path_main:"follow the path upto VKJ from main gate. and go straight. turn left. the orange colour block on left side was A S K 3.",
      },
      {
        name: "A S K 4",
        type: "Research block",
        ...
        lng: 79.022393,
        tags: ["Research block"],
        path_boys:"follow the path upto VKJ from hostel. and go straight. turn left. the orange colour block on right side was A S K 4",
        path_girls:"from hostel gate take left turn. and go straight. and again turn left. the orange colour block on right side was A S K 4.",
        path_main:"follow the path upto VKJ from main gate. and go straight. turn left. the orange colour block on right side was A S K 4.",
      },
      {
        name: "Hostel Mega",
        type: "Hostel",
        ...
        lng: 79.022012,
        tags: ["hostel"],
        path_main:"take right. and go straight to the end of road. the hostel was on right side. enter through the gate hostel after permission.",
      },
      {
        name: "PV hostel",
        type: "Hostel",
